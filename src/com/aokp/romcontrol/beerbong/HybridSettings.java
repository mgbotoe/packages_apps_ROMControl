...
public class HybridSettings extends AOKPPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int aprop = ExtendedPropertiesUtils
                .getActualProperty(ExtendedPropertiesUtils.PARANOID_PREFIX + "user_default_layout");
        if (aprop == 0) {
            aprop = prop;
        }
    ...
    private void updateSummaries() {
        ...
        dpi = ExtendedPropertiesUtils
                .getActualProperty(ExtendedPropertiesUtils.PARANOID_PREFIX + "user_default_dpi");
        if (dpi == 0) {
    ...
    private void showAppsDpiDialog() {
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Applications.addProperty(mContext,
                                ExtendedPropertiesUtils.PARANOID_PREFIX + "user_default_dpi",
                                mAppDpiProgress, false);
                        Applications.addProperty(mContext,
                                ExtendedPropertiesUtils.PARANOID_PREFIX + "system_default_dpi",
                                mAppDpiProgress, false);
                    }
                }).create().show();
    }
